...
class Job(models.Model):
    ...
    failure_type = models.ForeignKey(FailureType, on_delete=models.CASCADE, related_name='jobs')
...
class JobNote(models.Model):
    ...
    job = models.ForeignKey(Job, on_delete=models.CASCADE)
    failure_type = models.ForeignKey(FailureType, on_delete=models.CASCADE)
    user = models.ForeignKey(User, on_delete=models.CASCADE, null=True)  # null if autoclassified
